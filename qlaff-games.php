				...
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<tr>
							...
							<td class="code" style="text-align: center; padding: 20px; width: 400px;">
								<h3>How to place the game:</h3>
								1. Search the game you want to place<br/>
								2. Save the setting for size, partner, channel, geo and # of popvers by clicking:
								...
								<br/>
								3. Place this code to the page: <br/><br/>
								<i>in the code</i><br/>
								<b>&lt;?php qlaff_game(<?php echo $topgamename; ?>,<?php echo $toplang; ?>,<?php echo $toptype; ?>); ?&gt;</b><br/><br/>
								<i>in the post/page</i><br/>
								<b>[qlaff_game name="<?php echo $topgamename; ?>" lang="<?php echo $toplang; ?>" type="<?php echo $toptype; ?>"]</b><br/><br/>
...
function qlaff_game_shortcode( $atts ) {
	...
	return qlaff_game($name,$lang,$type);
}
add_shortcode( 'qlaff_game', 'qlaff_game_shortcode' );
